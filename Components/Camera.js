    ...
    if (hasCameraPermission != true) {
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', width: 250, alignSelf: 'center' }}>
                ...
                <Text style={{ textAlign: 'center', fontSize: 15 }}>You are probably getting this screen because you don't have Camera access enabled for HÖBOscan</Text>
    ...
    if (showScreen) {
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', width: 250, alignSelf: 'center' }}>
                <Image source={require('../assets/hoboscan.png')} style={{ width: 300, height: 300 }} />
                <Text style={{ fontSize: 25 }}>Ayyy!</Text>
                <Text style={{ textAlign: 'center', fontSize: 15 }}>To select an image you need to have Camera Roll access enabled for HÖBOscan</Text>
                <Button title="Enable Camera Roll Access" onPress={() => Linking.openSettings()} />
                <Button title="Cancel" onPress={() => setShowScreen(false)} />
            </View>
        );
    } else {
        return (
